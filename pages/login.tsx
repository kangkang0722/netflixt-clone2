...
function login() {
  ...
  return (
    <div className="relative flex h-screen w-screen flex-clo bg-black md:items-center md:justify-center md:bg-transparent">
      <Head>
        <title>Netflix</title>
      ...
      className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14">
        <h1 className="text-4xl font-simibold ">Sign In</h1>
